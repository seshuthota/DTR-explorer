...
# Colab-friendly SFT LoRA training wrapper.
# Conservative defaults for ~15-16GB VRAM GPUs.
#
# Example:
#   DATASET_PATH=data/dtr_filtered_sft.jsonl bash scripts/colab/20_train_sft.sh
...
OUT_DIR="${OUT_DIR:-models/dtr-tuned-1.2b-colab}"
